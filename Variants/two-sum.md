Given an array of pairs `dominoes` integers and an integer `target`, return the number of unique domino pairs `[a1, a2]` and `[b1, b2]` where `a1+b1=target` and `a2+b2=target`.
