...
1623| [All Valid Triplets That Can Represent a Country](https://leetcode.com/problems/all-valid-triplets-that-can-represent-a-country/) | [MySQL](./all-valid-triplets-that-can-represent-a-country.sql) | _O(n^2)_ | _O(n)_       | Easy           ||
