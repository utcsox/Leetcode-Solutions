You are given two arrays departures and returns where departure [i] and returns[i] are ticket prices for departing and returning flights on the ith day, respectively.
